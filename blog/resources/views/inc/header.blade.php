<nav class="site-header sticky-top py-1">
    <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="p-2 text-dark" href="{{ route('products') }}">Каталог товаров</a>
        <a class="p-2 text-dark" href="{{ route('contact') }}">Контакы</a>
        <a class="p-2 text-dark" href="{{ route('about') }}">Информация о компании</a>
        <a class="p-2 text-dark" href="{{ route('contact-data') }}">Сообщения</a>
        <a class="p-2 text-dark" href="{{ route('entrance') }}">Войти</a>
        <a class="p-2 text-dark" href="{{ route('reg') }}">Зарегистрироваться</a>
